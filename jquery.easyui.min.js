...
(function($) {
        ...
        function _bc7(aa) {
            ...
            for (var i = 0; i < aa.length; i++) {
                ...
                if (aa[i] != "|") {
                    ...
                    span.html(aa[i]);
                    //---
                    span = $("<span><i></i></span>").appendTo(_bc8);
                    span.find('i').html(aa[i]);
                    //---
                    if (opts.mode == "h") {
                        if (i == (aa.length - 1)) {
                            span.css({
    ...
    function _bca(_bcb) {
        ...
        if (opts.range) {
            ...
            //---
            opts.middleTip = $('<span class="slider-middleTip"></span>').appendTo(_bce)
            //---
        }
    ...
    function _bd5(_bd6, _bd7) {
        ...
        for (var i = 0; i < _bd7.length; i++) {
            ...
            //--
            var theIndex = _bd9.find('.slider-handle').index(_bde);
            //--
            if (opts.showTip) {
                tip.show();
                var htmlStr = opts.tipFormatter.call(_bd6, _bdc);
                if (theIndex === 0) {
                    opts.tip1Text = htmlStr;
                } else {
                    opts.tip2Text = htmlStr;
                    opts.middleTip.html(opts.tip1Text + " ... " + htmlStr)
                }
                tip.html(htmlStr);
            } else {
                tip.hide();
            }
            // ----  _bd9(slider) _bde(slider-handle)
            ...
            if (opts.mode == "h") {
                if (theIndex === 0) {
                    ...
                    opts.tip2Left = pos;
                    var middlePos = "left:" + (parseFloat(opts.tip1Left) + parseFloat(pos)) / 2 + "px;";
                    opts.middleTip.attr("style", middlePos + "margin-left:" + (-Math.round(opts.middleTip.outerWidth() / 2)) + "px")
                    var _be0 = "left:" + pos + "px;";
                    _bde.attr("style", _be0);
                    tip.attr("style", _be0 + "margin-left:" + (-Math.round(tip.outerWidth() / 2)) + "px");
                    tip.hide();
